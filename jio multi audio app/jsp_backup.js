...
"use strict";
	...
	function selector(id){
		...
		if(a == 'http://localhost/jio%20multi%20audio%20app/categories.html')
			{
				window.location.href='http://localhost/jio%20multi%20audio%20app/audio_edit(1).html';		
			}

		if(a == 'http://localhost/jio%20multi%20audio%20app/audio_edit(1).html')
			{
				window.location.href='http://localhost/jio%20multi%20audio%20app/audio_player.html';		
			}	
	...
	/*function brnprint_aud(bc){
		for(let i =0 ; i<cate_names.length;i++)
			{	//console.log(bc);
				document.getElementById("cont1").innerHTML += "<button class=\"c1\" id=\""+(i+3)+"\" tabindex=\""+(i+3)+"\" onClick=\"selector(this.id)\" ><h6>"+ vid_titles[i]+"</h6></button>"; 
			}
	}

	function brnprint_cat(bc){
		for(let i =0 ; i<cate_names.length;i++)
			{	
				document.getElementById("cont").innerHTML += "<button class=\"c1\" id=\""+(i+3)+"\" tabindex=\""+(i+3)+"\" onClick=\"selector(this.id)\" ><h6>"+ cate_names[i]+"</h6></button>";
			}
	}*/
...
//console.log(window.location.href);
		...
		let obj= data.googlevideos;
			...
			if(window.location.href == 'http://localhost/jio%20multi%20audio%20app/categories.html')
			{
				obj=document.getElementById("cont");

				for(let i =0 ; i<cate_names.length;i++)
				{	
					obj.innerHTML += "<button class=\"c1\" id=\""+(i+3)+"\" tabindex=\""+(i+3)+"\" onClick=\"selector(this.id)\" ><h6>"+ cate_names[i]+"</h6></button>";
				}
